  ...
  return (
    <footer className="mt-10 py-6 font-qs px-4 divide-y bg-slate-800 text-white">
      ...
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <Link
              to="/"
              className="cursor-pointer inter flex gap-1 items-center "
            >
              <div>
                <img className="size-8 md:size-20 rounded" src={logo} alt="" />
              </div>
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              <Link
                to={"https://www.facebook.com/nahid.bin.w"}
                rel="noopener noreferrer"
                href="https://www.facebook.com/nahid.bin.w"
                title="Facebook"
              ...
              <Link
                to={"https://twitter.com/nahidbinwadood"}
                rel="noopener noreferrer"
                href=""
                title="Twitter"
                className="flex items-center p-1"
              ...
              <Link
                to={""}
                rel="noopener noreferrer"
                href="https://www.instagram.com/__nahid_bin_wadood__/"
                title="Instagram"
                className="flex items-center p-1"
              >
                <svg
      ...
      <div className="py-6 text-sm text-center text-white">
        © 2024 GameLand Company Co. All rights reserved.
      </div>
    </footer>
  );
};
